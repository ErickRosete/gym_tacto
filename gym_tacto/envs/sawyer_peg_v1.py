...
class SawyerPegEnv(gym.Env):
    ...
    def load_board_and_peg(self):
        ...
        if self.difficulty == "easy":
            board_path = pkg_path("envs/data/peg_in_hole_board/board_easy.urdf")   
        elif self.difficulty == "hard":
            board_path = pkg_path("envs/data/peg_in_hole_board/board_hard.urdf")   
        else:
...
def make_env_sawyer_peg_v1(cfg):
    env = gym.make('gym_tacto:sawyer-peg-v1', cfg=cfg)
